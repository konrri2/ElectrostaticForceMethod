...
var categoriesSamples = [
            "Allegro   Dom i Ogród   Meble   Salon   Stoły",
...
let tree1 = Tree(initialCategories: categoriesSamples)

print()
print(tree1.root)

let leaf1 = tree1.addBranch(categoriesChain: categoriesSamples[1])
let leaf2 = tree1.addBranch(categoriesChain: categoriesSamples[2])

let dist = Tree.distance(leaf1, leaf2)
print()
print(dist)
